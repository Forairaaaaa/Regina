...
namespace m5
{
    ...
    public:
        ...
        [[deprecated("use wasDecideClickCount()")]] bool wasDeciedClickCount(void) const { return wasDecideClickCount(); }
        ...
        [[deprecated("use wasReleaseFor()")]] bool wasReleasefor(std::uint32_t ms) const { return wasReleaseFor(ms); }
